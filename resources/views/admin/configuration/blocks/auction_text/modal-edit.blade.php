{{-- MODAL EDITAR --}}
<div class="modal fade" id="modalEditTextoAuction" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title text-color-3">Editar Presentación de Remates</h2>
            ...
            >
                ...
                <div class="modal-body">
                    ...
                    <div class="rich-text-field">
                        ...
                        <input type="hidden" name="description" id="apDescription">
                    </div>                        
