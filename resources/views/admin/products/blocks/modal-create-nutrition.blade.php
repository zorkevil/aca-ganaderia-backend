<div class="modal fade" id="modalProductoNutricion" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">

      <div class="modal-header">
        <h2 class="modal-title text-color-3">Agregar Producto – Nutrición</h2>
      ...
      <div class="modal-body">
        <form method="POST"
          ...
          <input type="hidden" name="general_category_id" value="{{ $nutritionId }}">
            ...
            {{-- Descripción --}}
            <div class="mb-3 form-floating">
              <textarea name="description" class="form-control" style="min-height: 100px !important;"></textarea>
            ...
            <div class="row">
              <div class="col-6 mb-3">     
                <div class="form-floating">
                  <textarea name="presentation" class="form-control" style="min-height: 100px !important;"></textarea>
                  <label>Presentación</label>
                </div>
              </div>
              <div class="col-6 mb-3">
                <div class="form-floating">
                  <textarea name="administration" class="form-control" style="min-height: 100px !important;"></textarea>
            ...
            <div class="row">
              <div class="col-6 mb-3">
                <div class="form-floating">
                  <textarea name="second_category" class="form-control" style="min-height: 100px !important;"></textarea>
                  <label>Categoría</label>
                </div>
              </div>
              <div class="col-6 mb-3">
                <div class="form-floating">
                  <textarea name="dosage" class="form-control" style="min-height: 100px !important;"></textarea>
