    ...
    <div class="modal-content">
      ...
      <form id="formEditProductoNutricion"
        ...
        <div class="modal-body">
          ...
          {{-- Descripción --}}
          <div class="mb-3 form-floating">
            <textarea name="description" id="editDescription" class="form-control" style="min-height:100px"></textarea>
          ...
          <div class="row">
            <div class="col-6 mb-3 form-floating">
              <textarea name="presentation" id="editPresentation" class="form-control" style="min-height:100px"></textarea>
              <label>Presentación</label>
            </div>
            <div class="col-6 mb-3 form-floating">
              <textarea name="administration" id="editAdministration" class="form-control" style="min-height:100px"></textarea>
          ...
          <div class="row">
            <div class="col-6 mb-3 form-floating">
              <textarea name="second_category" id="editSecondCategory" class="form-control" style="min-height:100px"></textarea>
              <label>Categoría</label>
            </div>
            <div class="col-6 mb-3 form-floating">
              <textarea name="dosage" id="editDosage" class="form-control" style="min-height:100px"></textarea>
